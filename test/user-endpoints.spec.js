    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'fear', translation: 'man' },
            { original: 'cailin', translation: 'girl' },
            { original: 'buachaill', translation: 'boy' },
            { original: 'agus', translation: 'and' },
            { original: 'bean', translation: 'woman' },
            { original: 'ithim', translation: 'I eat' },
            { original: 'uisce', translation: 'water' },
            { original: 'an', translation: 'the' },
          ]
        }
        return supertest(app)
          .post('/api/user')
